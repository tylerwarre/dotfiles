...
# General options
filename_suffix="#{session_name}_#{window_index}-#{window_name}_#{pane_index}_%Y-%m-%d_T%H-%M-%S.log"

# Logging options
default_logging_path="$HOME/.tmux/logs"
...
default_screen_capture_path="$HOME/.tmux/captures"
...
default_save_complete_history_path="$HOME/.tmux/logs"
...
default_save_complete_history_filename="${filename_suffix}"
